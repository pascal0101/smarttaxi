...
<div class="wrapper">
  ...
  <section class="invoice">
    ...
    <!-- /.row -->
    <h6 align="center"><strong>Liste des Passagers à SmartTaxi</strong></h6>
    <!-- Table row -->
    <div class="row">
      <div class="col-12 table-responsive">
        <table class="table table-striped">
              ...
              @foreach($passagers as $passager)
                <tbody>
                <tr>
                  <td>{{($passager->NomPass)}}</td>
                  <td>{{($passager->PrenPass)}}</td>
                   <td>{{($passager->SexePass)}}</td>
                  <td>{{($passager->AdrPass)}}</td>
