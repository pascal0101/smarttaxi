...
<body>
  ...
  <div class="jumbotron" >
  <img height="10%" width="20%" class="panelContenue" src="{{ asset('storage/'.$chauffeur ->photo) }}" class="img-responsive">  
 <center>
          <table>
          <tr>
             <td><strong>Nom: {{($chauffeur->NomchauffTaxi)}}</strong></td>
             
           </tr> 
            <tr><td><strong>Prenom: {{($chauffeur->PrechauffTaxi)}}</strong></td></tr>
           <tr> 
               <td><strong>Sexe: {{($chauffeur->Sexe)}}</strong></td>
                 
            </tr> 
          <tr><td><strong>Adresse: {{($chauffeur->AdrChauffTaxi)}}</strong></td></tr>    
            <tr>
                   <td><strong>Categorie : {{($chauffeur->CategoriPermis)}}</strong></td>
                   
              </tr>
              <tr> <td><strong>Numero : {{($chauffeur->Numero)}}</strong></td></tr>
